...
class Audio:
    ...
    *The base class for all other Audio type classes.*
    ...
    The 'ID' and 'uploadtime' attributes are generated if not found in the metadata (considered as the
    first initialization of the object).
    The 'ID' is generated by taking the absolute value of the hash generated for a string that contains
    the name, duration and uploadtime attributes.
    ...
    *****************
    ...
    - ``name``:     An str that describes the name of the audio file. Maximum length of 100 characters.
    - ``duration``: A positive int that describes the length of the audio file. Must be a positive number.
    - ``uploadtime``: A datetime object that describes the time at which the audio file was uploaded.
    - ``metadata``: A dict that contains the audio file metadata.

    **************
    Class Methods:
    **************
    - ``validate_string``:  A classmethod that determines if a given object is a string under 100 characters.
    - ``validate_duration``:    A classmethod that determines if a given object is a positive integer.
    """
    metadata: dict
    ...
    def __post_init__(self):
        ...
        # Set generic value if 'type' not found
...
class Song(Audio):
    ...
    *****************
    ...
    - ``name``:     An str that describes the name of the song. Maximum length of 100 characters.
    - ``duration``: A positive int that describes the length of the song. Must be a positive number.
    - ``uploadtime``: A datetime object that describes the time at which the song was uploaded.
...
class Podcast(Audio):
    ...
    *****************
    ...
    - ``name``:     An str that describes the name of the podcast. Maximum length of 100 characters.
    - ``host``:     An str that describes the host of the podcast. Maximum length of 100 characters.
    - ``participants``: A list of str that describes the participants of the podcast.
    - ``duration``: A positive int that describes the length of the podcast. Must be a positive number.
    - ``uploadtime``: A datetime object that describes the time at which the podcast was uploaded.
    ...
    **************
    - ``validate_string``:  A classmethod that determines if a given object is a string under 100 characters.
    - ``validate_duration``:    A classmethod that determines if a given object is a positive integer.
    - ``validate_participants``:    A classmethod that determines if a given object is a list of valid strings.
    """
    metadata: dict
    ...
    def validate_participants(cls, participants: list) -> typing.Tuple[bool, str]:
        """
        A classmethod that determines if a given object is a list of valid strings (under 100 characters).
        Returns a validity bool and and an error str in a tuple.
        """
...
class Audiobook(Audio):
    ...
    *****************
    - ``ID``:       An int that uniquely identifies the song.
    - ``name``:     An str that describes the name of the song. Maximum length of 100 characters.
    - ``author``:   An str that describes the author of the audiobook. Maximum length of 100 characters.
    - ``narrator``: An str that describes the narrator of the audiobook. Maximum length of 100 characters.
    - ``duration``: A positive int that describes the length of the song. Must be a positive number.
    - ``uploadtime``: A datetime object that describes the time at which the song was uploaded.
    - ``metadata``: A dict that contains the song metadata.
